...
-- ========== 插入 20 个用户资料（含 traits_summary 和 city_id） ==========
-- 城市 ID 参照 V4__add_locations.sql:
-- 北京市=1, 上海市=3, 重庆市=4, 南京市=63, 杭州市=76, 广州市=187, 深圳市=189, 武汉市=156, 西安市=259, 成都市=208
...
-- ========== 从 profiles.traits_summary JSON 解析生成 user_traits 数据 ==========
-- profiles id 与 user_id 一致（1-20），因为 AUTO_INCREMENT=1 且按顺序插入
-- source_message_id = NULL（测试用户没有真实对话记录）
